...
import { Calendar as CalendarIcon, Zap, Users, Search, MapPin } from "lucide-react";
  ...
  return (
    <section className="relative py-20 px-4">
      <div className="container mx-auto text-center">
        ...
        {/* Quick Search Widget */}
        <Card className="max-w-3xl mx-auto mb-12 bg-card/80 backdrop-blur-sm border-border/50">
